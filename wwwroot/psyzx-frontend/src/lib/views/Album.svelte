...
{#if showPlaylistModal}
    <div class="modal-backdrop" use:portal in:fade={{duration: 200}} out:fade={{duration: 150}} on:click={closePlaylistSelector}>
        <div class="modal-glass-card" in:scale={{start: 0.95, duration: 250, opacity: 0}} on:click|stopPropagation>
            <div class="modal-header">
                <h3>Add to Playlist</h3>
                <button class="btn-close" on:click={closePlaylistSelector}>
...
<style>
    ...
    .modal-backdrop {
        position: fixed; top: 0; left: 0; width: 100vw; height: 100vh;
        background: rgba(0,0,0,0.20); backdrop-filter: blur(1px);
        z-index: 999999; display: flex; align-items: center; justify-content: center;
    }
